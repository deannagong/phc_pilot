...
psych::alpha(df[, c('Responsibility_Clarity', 'Workload_Reasonable', 'Authority_Understanding', 'Opinion_Expression', 'boss_flex')])$total$raw_alpha # dropping boss_flex would improve alpha
psych::alpha(df[, c('Responsibility_Clarity', 'Workload_Reasonable', 'Authority_Understanding', 'Opinion_Expression')])$total$raw_alpha
psych::alpha(df[, c('Health_Center_2', 'Health_Center_3', 'Health_Center_4', 'Health_Center_5', 'Health_Center_6', 'Health_Center_7')])$total$raw_alpha # no need for alteration
psych::alpha(df[, c("Understand_CommunityNeeds", "CareSystem", "TailoredServices", "ResourceIntegration", "CooperationWithInstitutions")])$total$raw_alpha # dropping CooperationWithInstitutions would improve alpha
psych::alpha(df[, c("Understand_CommunityNeeds", "CareSystem", "TailoredServices", "ResourceIntegration")])$total$raw_alpha

## Test alpha for all variables
pred <- df[, c("fatigue_01", "fatigue_02", "fatigue_03", "fatigue_04","fatigue_05",
               'Responsibility_Clarity', 'Workload_Reasonable', 'Authority_Understanding', 'Opinion_Expression',
               'Health_Center_2', 'Health_Center_3', 'Health_Center_4', 'Health_Center_5',
               'Health_Center_6', 'Health_Center_7', 'CareSystem', 
...
'
fit_cfa <- cfa_fit_plot(cfa_model, data = df) # good!
...
sem_test1 <- '
  ...
  Fatigue ~ Working_Environment # Working environment influences levels of fatigue
  TransformToHealthCenter ~ PHC_task + Community + Fatigue + Working_Environment # Test potential relationships broadly
'
